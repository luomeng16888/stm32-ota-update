...
/* ============================================================
 *  Config structure (20 bytes, stored at FLASH_CONFIG_ADDR)
 *
 *    [0..3]   magic             0x4F544346 "OTCF"
 *    [4..7]   active_partition  PARTITION_C (0) or PARTITION_D (1)
 *    [8..11]  version_c         numeric version in APP_C
 *    [12..15] version_d         numeric version in APP_D
 *    [16..19] checksum          CRC32 of bytes [0..15]
 * ============================================================ */
#define OTA_CONFIG_MAGIC         0x4F544346
#define OTA_CONFIG_DATA_SIZE     16

/* Backup Register magic values */
#define BKUP_MAGIC               0x4F544234
#define BKUP_HEALTHY             0x48454C50
